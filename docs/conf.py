...
# build documents.
#
title = "stsci.imagestats v{:s}".format(stsci.imagestats.__version__)
...
latex_documents = [
    ("index", "imagestats.tex", "stsci.imagestats Documentation", author, "manual"),
]
...
man_pages = [("index", "imagestats", "stsci.imagestats Documentation", [author], 1)]
...
texinfo_documents = [
    (
        "index",
        "imagestats.tex",
        "stsci.imagestats Documentation",
        author,
        "index",
        "stsci.imagestats Documentation",
        "Miscellaneous",
