...
Documentation for `stsci.imagestats` is written in [Sphinx reStructuredText (`.rst`)](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html)
in this `docs/` directory, and is hosted online athttps://stsci.imagestats.readthedocs.io### Building documentation locally
